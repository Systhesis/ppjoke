 ...
 * TO-DO
 * @author neil.zhong
 * @date 7/18/21 4:26 PM
 */
@Navigator.Name("fixfragment")
public class FixFragmentNavigator extends FragmentNavigator {
    private static final String TAG = "Fra";
    Context mContext;
...
//        frag.setArguments(args);
    ...
    private String generateBackStackName(int backStackIndex, int desId) {
        return backStackIndex + "-" + desId;
    }
}
